...
2. **How do i get started?**
     ...
     Once your Waitlist application is approved, you become an invited beta user of Clacky. You will receive an email containing an activation code and a registration link. Using this link and the invitation code, you can register for Clacky and start using it.
<br/>
