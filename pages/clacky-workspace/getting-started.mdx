...
Creating a new thread is as simple as chatting with Marvin. Marvin will automatically identify task requirements and create a Specification based on your conversation.
